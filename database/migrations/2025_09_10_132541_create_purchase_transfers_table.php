...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('purchase_transfers', function (Blueprint $table) {
            $table->id();
            $table->foreignId('from_store_id')->nullable()->constrained('purchase_stores')->onUpdate('cascade')->onDelete('cascade');
            $table->foreignId('to_store_id')->nullable()->constrained('purchase_stores')->onUpdate('cascade')->onDelete('cascade');
