...
Route::middleware(['auth:sanctum', 'IsCashier'])->group(function(){
    ...
    ->group(function(){
        ...
        Route::post('/take_away_dine_in', 'take_away_dine_in');
        
        Route::post('/end_time_session', 'end_time_session');
    ...
    ->prefix("orders")->group(function(){
        ...
        Route::get('/desktop_notifications', 'desktop_notifications')->withOutMiddleware(['auth:sanctum', 'IsCashier']);
