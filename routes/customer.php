...
Route::middleware(['auth:sanctum', 'IsCustomer'])->group(function(){
    Route::controller(HomeController::class)->prefix('home')->group(function(){
        ...
        Route::get('/banner_products/{id}', 'banner_products')->withOutMiddleware(['auth:sanctum', 'IsCustomer']);
        ...
        Route::get('/products_in_category_mobile/{id}', 'products_in_category_mobile')->withOutMiddleware(['auth:sanctum', 'IsCustomer']);
        ...
        Route::get('/product_item_web/{id}', 'product_item_web')->withOutMiddleware(['auth:sanctum', 'IsCustomer']);
        Route::get('/product_web_item/{id}', 'product_web_item')->withOutMiddleware(['auth:sanctum', 'IsCustomer']);
