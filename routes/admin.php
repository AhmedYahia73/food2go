...
Route::middleware(['auth:sanctum', 'IsAdmin'])->group(function(){
    ...
    ->prefix('recipe')->group(function(){
        ...
        Route::post('/add_product_recipe/{id?}', 'addProductRecipe')->middleware('can:add_recipe');
    ...
    ->prefix('order')->group(function(){
        ...
        Route::get('/my_orders_lists', 'my_orders_lists')->withOutMiddleware(['IsAdmin'])->middleware(['IsAdminOrBranch']);
    ...
    ->prefix('home')->group(function(){
        ...
        Route::get('/notifications_count', 'notifications_count')->withOutMiddleware(['IsAdmin'])->middleware(['IsAdminOrBranch']);
        Route::get('/notifications', 'notifications')->withOutMiddleware(['IsAdmin'])->middleware(['IsAdminOrBranch']);
        Route::post('/notifications/mark_as_read', 'mark_notification_read')->withOutMiddleware(['IsAdmin'])->middleware(['IsAdminOrBranch']);
    ...
    ->prefix('banner')->group(function(){
        ...
        Route::get('/lists/{id}', 'lists')->middleware('can:view_banner');
    ...
    Route::prefix('product')->group(function(){
        Route::controller(ProductController::class)->group(function(){
            ...
            Route::put('/status/{id}', 'status')->middleware('can:edit_product');
