...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'weight_point' => ['sometimes', 'numeric'],
            'weight_status' => ['sometimes', 'boolean'],
            ...
            'product_time' => ['sometimes', 'boolean'],
            'unit_time' => ['required_if:product_time,true,1', 'nullable', 'numeric', 'min:1'],
            'min_time' => ['nullable', 'numeric', 'min:0'],
            'extra_time' => ['required_if:product_time,true,1', 'nullable', 'boolean'],
            'extra_unit_time' => ['required_if:extra_time,true,1', 'nullable', 'numeric', 'min:1'],
            'extra_time_price' => ['required_if:extra_time,true,1', 'nullable', 'numeric', 'min:0'],
