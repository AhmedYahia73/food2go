...
class OrderController extends Controller
{
    ...
    public function order($id){
        ...
        'notes', 'coupon_discount', 'order_number', 'payment_method_id',
        'status', 'points', 'rejected_reason', 'transaction_id');
        }, 'branch', 'delivery', 'payment_method', 'address.zone', 'admin:id,name,email,phone'])
        ->find($id);
    ...
    public function invoice($id){
        ...
        $order = $this->orders
        ->with(['user', 'address.zone.city', 'admin:id,name,email,phone', 'branch', 'delivery'])
        ->find($id);
    ...
    public function order_filter_date(Request $request){
        ...
        // date, date_to, branch_id, type => all,pending,confirmed,processing,out_for_delivery,delivered,returned,faild_to_deliver,canceled,scheduled,refund
        $validator = Validator::make($request->all(), [
            'date' => 'required|date',
