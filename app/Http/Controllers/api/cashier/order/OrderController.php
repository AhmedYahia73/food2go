...
class OrderController extends Controller
{
    ...
    public function order_checkout(Request $request, $id){
        ...
        $order_number = $order->order_number ?? $this->order_num_today($order->id);
        $order_id = $order->order_number ?? $this->order_num_today($order->id);
    ...
    public function desktop_notifications(Request $request){
        $time_sittings = $this->TimeSittings 
        ->get();
        $delivery_time = $this->settings
        ->where("name", "delivery_time")
